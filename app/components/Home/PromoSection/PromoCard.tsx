...
function PromoCard({ promo }: Props) {
  return (
    <article className="flex w-96 rounded-lg shrink-0 shadow-lg text-gray-500 hover:bg-green-200 hover:text-green-600 transition-all duration-200 ease-out bg-slate-300">
