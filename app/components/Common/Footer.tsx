...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-200 text-gray-600">
      {/* Footer Smaller Screen */}

      <FooterMobile />

      {/* Footer Large Screen */}
      <section className="hidden md:flex  justify-around items-center border-t border-slate-100 py-12 px-12 text-gray-600">
